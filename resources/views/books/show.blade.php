            ...
            <div class="starts">
               <div class="start">
                <div class="img_book">
                  ...
                  <img style="width: 40px" height="40px" src="/img/green_tinagle.png" alt="Descripción de la imagen" data-toggle="modal" data-target="#exampleModal">
              ...
              <div class="modal fade" id="exampleText" tabindex="-1" role="dialog" aria-labelledby="exampleTextLabel" aria-hidden="true">
               ...
               <div class="start">
                <img style="width: 40px" height="40px" src="/img/map.png" alt="Descripción de la imagen" data-toggle="modal" data-target="#exampleModal">
               </div>
            </div>
